...
/**
 * Разбирает строку из инлайн-поля уведомления («Изменить» во время отдыха) по типу упражнения. null
 * — не удалось понять ввод; вызывающий в этом случае просто ничего не меняет.
 *
