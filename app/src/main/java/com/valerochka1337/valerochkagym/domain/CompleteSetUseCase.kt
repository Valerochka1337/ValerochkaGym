...
constructor(
  ...
  /**
   * Отдых не стартует, если подход не принадлежит активной тренировке — но отметка ставится. При
   * выключенном [GymSettings.restAutostart] отметка тоже ставится, а таймер не запускается.
   */
