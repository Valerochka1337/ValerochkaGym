...
/**
 * Разворачивает тренировку в плоские строки для Google Sheets: одна строка на каждый выполненный
 * подход. Порядок колонок строго соответствует [HEADER_ROW] — эти два списка связаны контрактом и
