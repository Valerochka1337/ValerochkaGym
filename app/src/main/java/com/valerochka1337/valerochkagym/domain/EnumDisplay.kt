...
/**
 * Разбирает русское имя группы мышц обратно в [MuscleGroup] (обратное к [displayName]). Сравнение
 * регистронезависимо и без пробелов по краям. Неизвестная метка → [MuscleGroup.FULL_BODY], чтобы
 * импорт из таблицы не падал на нестандартных значениях.
 */
