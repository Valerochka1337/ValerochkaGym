 ...
 * [SetMutation.transform]. Так быстрые тапы по степперам и клавиатурный ввод не затирают друг
 * друга (lost update).
 *
 ...
 * [com.valerochka1337.valerochkagym.service.WorkoutSessionService]). Два независимых канала свели бы
 * защиту на нет, поэтому потребитель ровно один и живёт столько же, сколько процесс.
 */
@Singleton
class WorkoutSetMutator @Inject constructor(
    ...
    fun edit(setId: Long, transform: (WorkoutSetEntity) -> WorkoutSetEntity) = enqueue(setId, transform)
