 ...
 *
 * Ступенчатая схема (прямая работа 1.0, косвенная 0.5, стабилизация 0), а не линейная
 * `contribution / 100`: именно ступени показали лучшую предсказательную силу в мета-анализе
 * дозозависимости (Pelland 2026, 67 исследований). Линейная схема раздувает объём
 * стабилизаторам — двадцать жимов лёжа насчитали бы прессу «2–4 подхода», которых там нет.
 */
