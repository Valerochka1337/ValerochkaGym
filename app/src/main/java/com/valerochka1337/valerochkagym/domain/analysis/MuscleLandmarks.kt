 ...
 * связан с большей гипертрофией, но отдача снижается, а единого универсального оптимума или потолка
 * восстановления данные не задают. Шкала помогает читать собственную историю, а не выносит вердикт
 * восстановлению.
 *
...
fun volumeZoneFor(weeklySets: Double): VolumeZone =
    when {
...
fun Muscle.zoneFor(weeklySets: Double): VolumeZone = volumeZoneFor(weeklySets)
