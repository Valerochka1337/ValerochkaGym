...
/**
 * Краткая запись одного подхода по типу упражнения: STRENGTH — «30×10», TIMED — «60 сек»,
 * CARDIO — «10 км/ч · 5% · 12 мин». null — когда заполнять нечем.
 *
 ...
 * уведомление активной тренировки и плашка «тренировка идёт» — форматирование должно быть одно
 * на все места, а тянуть ради него DAO незачем.
 */
fun formatSet(set: WorkoutSetEntity, type: ExerciseType): String? = when (type) {
