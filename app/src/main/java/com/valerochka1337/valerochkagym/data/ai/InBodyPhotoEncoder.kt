 ...
 */
@Singleton
class AndroidInBodyPhotoEncoder
@Inject
constructor(
          ...
          try {
            ...
            while (
                jpeg.size > MAX_JPEG_BYTES &&
                    maxOf(prepared.width, prepared.height) > MIN_IMAGE_SIDE
            ) {
  ...
  private companion object {
    ...
    const val TOO_LARGE_IMAGE_MESSAGE =
        "Фото слишком большое для безопасной отправки — снимите лист ближе"
  }
}
