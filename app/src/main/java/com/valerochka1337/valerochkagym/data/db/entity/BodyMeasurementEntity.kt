 ...
 * изменение. Для ручной записи масса жира остаётся производной (`вес × процент жира`), а InBody
 * может сохранить напечатанное аппаратом округлённое значение в [bodyFatMassKg].
 */
@Entity(
