  ...
  val entries: List<Equipment> =
      listOf(
          ...
          Equipment(
              ...
              "Регулируемая скамья",
              "Скамьи",
              setOf("настраиваемая скамья"),
              setOf("adjustable_bench", "flat_bench", "incline_bench"),
          ),
          ...
          Equipment(
              "nordic_bench",
              "Скамья для нордических сгибаний",
              "Специализированное",
              setOf("нордическая скамья"),
              setOf("nordic_bench", "ankle_anchor"),
          ),
