 ...
 * серию удалять при следующем сохранении. Отсутствие правила на день недели = в этот день
 * тренировки не запланировано (неактивные дни в [WeeklySchedule.rules] просто отсутствуют).
 *
...
/**
 * Недельный шаблон расписания, целиком сериализуемый в один ключ DataStore. Содержит только
 * активные дни ([rules]); порядок не важен, но не должно быть двух правил на один [DayRule.isoDay].
 */
@Serializable
