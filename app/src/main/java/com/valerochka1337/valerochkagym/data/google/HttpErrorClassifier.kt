 ...
 *
 * Постоянные ошибки (нужно вмешательство пользователя): 401/403 — нет доступа, 404 — таблицы
 * нет, прочие 4xx — ошибка запроса. Временные (можно повторить): 429, 5xx и всё остальное.
 */
