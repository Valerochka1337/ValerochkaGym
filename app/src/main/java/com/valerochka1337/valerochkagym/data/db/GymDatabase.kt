        ...
        val MIGRATION_13_14: Migration = object : Migration(13, 14) {
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                try {
                    ...
                    db.execSQL("CREATE INDEX IF NOT EXISTS `index_health_reports_correctionOfVersion` ON `health_reports` (`correctionOfVersion`)")
                    db.execSQL("CREATE TABLE IF NOT EXISTS `health_report_snapshots` (`syncId` TEXT NOT NULL, `version` INTEGER NOT NULL, `updatedAt` INTEGER NOT NULL, `isTombstone` INTEGER NOT NULL, `canonicalPayload` TEXT NOT NULL, `payloadHash` TEXT, `operationId` TEXT, PRIMARY KEY(`syncId`, `version`))")
                    ...
                    db.execSQL("CREATE TABLE IF NOT EXISTS `health_restriction_snapshots` (`syncId` TEXT NOT NULL, `version` INTEGER NOT NULL, `updatedAt` INTEGER NOT NULL, `isTombstone` INTEGER NOT NULL, `canonicalPayload` TEXT NOT NULL, `payloadHash` TEXT, `originalText` TEXT, `operationId` TEXT, PRIMARY KEY(`syncId`, `version`))")
