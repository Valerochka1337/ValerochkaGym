...
constructor(
    ...
    eventBus: AppUpdateInstallEventBus,
) : AppUpdateInstaller {
  ...
  override fun verify(file: File, release: AppRelease) {
    ...
    val installedSigningInfo =
        installedInfo.signingInfo
  ...
  override fun unknownSourcesSettingsIntent(): Intent =
      Intent(
        ...
        val params =
            PackageInstaller.SessionParams(
                ...
                .apply {
                  ...
                  setOriginatingUri(release.apk.downloadUrl.toUri())
                  setReferrerUri(release.pageUrl.toUri())
                }
