...
@Serializable
internal enum class WeeklyScheduleOperationPhase { CREATE_NEW, CLEANUP_NEW, DELETE_OLD }
...
internal class WeeklyScheduleOperationJournal(
    ...
    suspend fun read(): WeeklyScheduleOperationRead = try {
        val raw = dataStore.data.first()[PENDING_OPERATION]
            ?: return WeeklyScheduleOperationRead.Absent
