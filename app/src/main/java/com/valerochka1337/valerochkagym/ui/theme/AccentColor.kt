...
/**
 * Историческая фирменная палитра и связанная с ней иконка лаунчера. Полные light/dark схемы Compose
 * определены отдельно в `StaticColorSchemes.kt`; эти четыре цвета сохраняются как совместимые
 * launcher-токены и ключ настройки. Каждому варианту соответствует свой `activity-alias` в
 * манифесте ([aliasName]), который включает
