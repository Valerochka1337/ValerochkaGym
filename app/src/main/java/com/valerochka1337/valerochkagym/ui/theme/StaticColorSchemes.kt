...
private val BrandTones = mapOf(
    AccentColor.GREEN to AccentTones(
    ...
    AccentColor.LIME to AccentTones(
    ...
    AccentColor.CYAN to AccentTones(
    ...
    AccentColor.CORAL to AccentTones(
...
private fun lightBrandColorScheme(tones: AccentTones): ColorScheme = lightColorScheme(
...
private fun darkBrandColorScheme(tones: AccentTones): ColorScheme = darkColorScheme(
