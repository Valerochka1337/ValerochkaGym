...
class Migration8To9Test {
    ...
    fun `migration keeps legacy rows and every completed and incomplete set`() {
        database().use { db ->
            db.execSQL("INSERT INTO exercises VALUES (1, 'Жим', 'CHEST', 'STRENGTH', 1, '11111111-1111-1111-1111-111111111111', 1)")
            db.execSQL("INSERT INTO routines VALUES (1, '22222222-2222-2222-2222-222222222222', 1, 'A', '')")
            ...
            db.query("SELECT sectionId, variantSyncId, variantNameSnapshot FROM workout_exercises WHERE id = 1").use { cursor ->
                cursor.moveToFirst()
    ...
    private fun database(): SupportSQLiteDatabase {
        val callback = object : SupportSQLiteOpenHelper.Callback(8) {
            override fun onCreate(db: SupportSQLiteDatabase) {
                db.execSQL("CREATE TABLE exercises (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name TEXT NOT NULL, muscleGroup TEXT NOT NULL, type TEXT NOT NULL, isCustom INTEGER NOT NULL, syncId TEXT NOT NULL, updatedAt INTEGER NOT NULL)")
                db.execSQL("CREATE TABLE routines (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, syncId TEXT NOT NULL, updatedAt INTEGER NOT NULL, name TEXT NOT NULL, note TEXT NOT NULL)")
                db.execSQL("CREATE TABLE workouts (id TEXT NOT NULL PRIMARY KEY, routineId INTEGER, name TEXT NOT NULL, startedAt INTEGER NOT NULL, finishedAt INTEGER, note TEXT NOT NULL, uploadStatus TEXT NOT NULL, uploadError TEXT)")
                db.execSQL("CREATE TABLE routine_exercises (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, routineId INTEGER NOT NULL, exerciseId INTEGER NOT NULL, position INTEGER NOT NULL, restSeconds INTEGER, plannedSetsJson TEXT NOT NULL)")
                db.execSQL("CREATE TABLE workout_exercises (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, workoutId TEXT NOT NULL, exerciseId INTEGER NOT NULL, position INTEGER NOT NULL)")
