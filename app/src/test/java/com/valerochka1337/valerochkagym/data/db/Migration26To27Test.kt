...
class Migration26To27Test {
  ...
  fun `preparation migration retains exact journals and existing participant operations`() {
    ...
    helper
        .runMigrationsAndValidate("preparation-26-27.db", 27, true, GymDatabase.MIGRATION_26_27)
        .use {
  ...
  fun `full historical migration retains routine and creates empty preparation journal`() {
    ...
    helper
        .runMigrationsAndValidate("preparation-1-27.db", 27, true, *GymDatabase.ALL_MIGRATIONS)
        .use {
