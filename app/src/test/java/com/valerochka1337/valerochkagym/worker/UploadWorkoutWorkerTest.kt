 ...
 * граница попыток — на последней транзиентной ошибке статус становится FAILED навсегда.
 * Воркер собирается [TestListenableWorkerBuilder]-ом с фабрикой, подставляющей фейки вместо Hilt.
 */
