...
/**
 * Unit tests for [iconResFor]. The mapping is a pure keyword function over the exercise name with a
 * muscle-group fallback, so no Room/Robolectric is needed — just int compares against the generated
 * `R.drawable` ids.
 */
class ExerciseIconTest {
  ...
  fun `barbell keywords map to barbell icon`() {
    ...
    assertEquals(
        R.drawable.ic_ex_barbell,
        iconResFor(ex("Трастеры со штангой", MuscleGroup.FULL_BODY)),
    )
  }
  ...
  fun `bodyweight and core keywords map to their icons`() {
    ...
    assertEquals(
        R.drawable.ic_ex_core,
        iconResFor(ex("Планка", MuscleGroup.CORE, ExerciseType.TIMED)),
    )
  ...
  fun `cardio machines map to their specific icons`() {
    assertEquals(
        ...
        iconResFor(ex("Беговая дорожка", MuscleGroup.CARDIO, ExerciseType.CARDIO)),
    )
    assertEquals(
        R.drawable.ic_ex_elliptical,
        iconResFor(ex("Эллиптический тренажёр", MuscleGroup.CARDIO, ExerciseType.CARDIO)),
    )
    assertEquals(
        R.drawable.ic_ex_rower,
        iconResFor(ex("Гребной тренажёр", MuscleGroup.CARDIO, ExerciseType.CARDIO)),
    )
    assertEquals(
        R.drawable.ic_ex_stepper,
        iconResFor(ex("Степпер", MuscleGroup.CARDIO, ExerciseType.CARDIO)),
    )
    assertEquals(
        R.drawable.ic_ex_stepper,
        iconResFor(ex("Лестничный тренажёр", MuscleGroup.CARDIO, ExerciseType.CARDIO)),
    )
    assertEquals(
        R.drawable.ic_ex_bike,
        iconResFor(ex("Air bike", MuscleGroup.CARDIO, ExerciseType.CARDIO)),
    )
    assertEquals(
        R.drawable.ic_ex_rower,
        iconResFor(ex("SkiErg", MuscleGroup.CARDIO, ExerciseType.CARDIO)),
    )
    assertEquals(
        R.drawable.ic_ex_elliptical,
        iconResFor(ex("Орбитрек", MuscleGroup.CARDIO, ExerciseType.CARDIO)),
    )
    assertEquals(
        R.drawable.ic_ex_bodyweight,
        iconResFor(ex("Скакалка", MuscleGroup.CARDIO, ExerciseType.CARDIO)),
    )
    assertEquals(
        R.drawable.ic_ex_bodyweight,
        iconResFor(ex("Плавание кролем", MuscleGroup.CARDIO, ExerciseType.CARDIO)),
    )
  ...
  fun `bicycle crunch is core, exercise bike is bike`() {
    ...
    assertEquals(
        R.drawable.ic_ex_bike,
        iconResFor(ex("Велотренажёр", MuscleGroup.CARDIO, ExerciseType.CARDIO)),
    )
  }
  ...
  /**
   * Каждое встроенное упражнение должно получать конкретную иконку, а кардио-группа —
   * кардио-иконку.
   */
  @Test
