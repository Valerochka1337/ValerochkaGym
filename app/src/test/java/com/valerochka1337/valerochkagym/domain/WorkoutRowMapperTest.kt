...
class WorkoutRowMapperTest {
            ...
            exercises =
                listOf(
                    exercise(
                        ...
                        sets =
                            listOf(
                                set(setIndex = 0, weightKg = 80.0, reps = 6, isCompleted = true)
                            ),
                    ),
                ),
        )
            ...
            exercises =
                listOf(
                    exercise(
                        ...
                        sets =
                            listOf(
                                set(setIndex = 0, weightKg = 60.0, reps = 8, isCompleted = true)
                            ),
                    ),
                ),
        )
            ...
            exercises =
                listOf(
                    exercise(
                        ...
                        sets =
                            listOf(
                                set(setIndex = 0, weightKg = 100.0, reps = 5, isCompleted = false)
                            ),
                    ),
                ),
        )
  ...
  private fun exercise(
      ...
      WorkoutExerciseWithSets(
          workoutExercise =
              WorkoutExerciseEntity(id = 0, workoutId = "w", exerciseId = 0, position = position),
